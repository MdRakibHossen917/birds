        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-800 mb-4">
              Cookie <span className="bg-gradient-to-r from-blue-600 to-orange-500 bg-clip-text text-transparent">Policy</span>
            </h1>
          ...
          <div className="bg-white rounded-xl shadow-xl p-8 md:p-12 border border-gray-100">
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 mb-4">1. What Are Cookies</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">6. Cookie Duration</h2>
                <p className="text-gray-600 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">7. Your Cookie Choices</h2>
                <p className="text-gray-600 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">8. Updates to This Cookie Policy</h2>
                <p className="text-gray-600 leading-relaxed">
